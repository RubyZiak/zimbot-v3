...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: '' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Mau donasi? Wa.me/60168172749 tinggal pm owner nya:* ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
...
if (isBan) throw mess.ban
		...
		ZimBotInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: `kira bot INC` }, { quoted: m }).catch((err) => m.reply('*Sorry Failed In Writing*')) 
	    }
	    break
case 'magernulis2': {            
if (isBan) throw mess.ban
		...
		ZimBotInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: `KIRA` }, { quoted: m }).catch((err) => m.reply('Sorry Failed In Writing*')) 
	    }
	    break
case 'magernulis3': {            
if (isBan) throw mess.ban
...
if (isBan) throw mess.ban
		...
		ZimBotInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: ` INC` }, { quoted: m }).catch((err) => m.reply('Sorry Failed In Writing*')) 
	    }
	    break
     ...
     if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                case 'nsfw': {
                 ...
                 ZimBotInc.sendMessage(from, {text: `*tobat la anak anjing*`, contextInfo: { mentionedJid : mems }}, {quoted:m})
                 } else if (args[0] === "off") {
...
urlButton: {
displayText: 'JOIN',
url: 'https://chat.whatsapp.com/C1c5eTqt6V16pTwrPNGdtw'
}
}, {
urlButton: {
displayText: 'GITHUB',
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `JOIN`, url : `https://chat.whatsapp.com/C1c5eTqt6V16pTwrPNGdtw` } }, { urlButton: { displayText: `GITHUB`, url : `Cari apa banh` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
